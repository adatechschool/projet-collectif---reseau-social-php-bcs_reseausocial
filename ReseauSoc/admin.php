                ...
                while ($tag = $lesInformations->fetch_assoc())
                {
                    ...
                    <article>
                        ...
                        <nav>
                            ...
                            | <a href="feed.php?<?php echo $tag['id']?>">Flux</a>
                            | <a href="settings.php?<?php echo $tag['id']?>">Paramètres</a>
                            | <a href="followers.php?<?php echo $tag['id']?>">Suiveurs</a>
                            | <a href="subscriptions.php?<?php echo $tag['id']?>">Abonnements</a>
                        </nav>
                    </article>
                <?php } ?>
            </main>
